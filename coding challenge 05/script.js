...
function totalTips() {
  ...
  if (meanMark > meanJohn){
    console.log(`Família de Mark gastou mais em gorjetas que a Família de John, gastaram um total de $${meanMark}`)
  } else if (meanMark < meanJohn ){
    console.log(`Família de John gastou mais em gorjetas que a Família de Mark, gastaram um total de $${meanJohn}`)
  } else {
